...
\begin{frame}[fragile]{Overview}
  ...
  \begin{itemize}
    ...
    \item Packaging Approach: devtools
    \item Documentation: roxygen2
...
\begin{frame}[fragile]{Packaging: devtools}
...
\begin{frame}[fragile]{Documentation}
  ...
  \begin{itemize}
    ...
    \item roxygen2 generation of R help pages
  \end{itemize}
...
\begin{frame}[fragile]{Documentation}
  ...
  \begin{itemize}
    \item 'Difficult' syntax. (Markdown spoilt me...)
  ...
  roxygen2 allows you to put special comments in your code and then generates the man pages for you.
...
\begin{frame}[fragile]{Deployment}
  ...
  My current deployment solutions are:
...
\begin{frame}[fragile]{Deploy with Docker}

  I think of docker as a scaled down virtual machine.

  \vspace{5mm}

  Use dockerhub to allow people to download a scaled down virtual machine that run the program you want to deploy.

  \vspace{5mm}

  Automated builds work really well.



\end{frame}

\begin{frame}[fragile]{Deploy with a web server}

  Instead of shipping code to other people, host a website where they can do their computations.

  \vspace{5mm}

  Shiny comes with a community server written in Node.js.

  \vspace{5mm}

  Run that on a VM you get from Long / Peter.

  \vspace{5mm}

  Then email one of them and ask them to work their magic.
